...
class LearningAgent(Agent):
    ...
    def __init__(self, env):
        ...
        self.epsilon = 0.4  # starting exploration probability
        self.decay_divisor = 600  # estimated total number of updates
        self.decay_rate = self.epsilon / self.decay_divisor

        self.learning_rate = 0.4  # alpha, incremental update of Q estimate
        self.discount = 0.4  # gamma for value iteration for Q estimate update
...
# Reviewer can ignore this, requires edits in environment.py and simulator.py
        ...
        for decay_divisor in decay_divisors:
            for learning_rate in learning_rates:
                for discount in discounts:
                    ...
                    sim.run(
                        n_trials=trials)  # run for a specified number of trials
...
def run():
    ...
    sim.run(n_trials=20000)  # run for a specified number of trials
    # NOTE: To quit midway, press Esc or close pygame window, or hit Ctrl+C
    # on the command-line
